...
var (
	Version   = "dev"     // Set via -ldflags "-X github.com/open-edge-platform/edge-node-agents/platform-update-agent/inbm/internal/inbd/telemetry.Version=x.x.x"
	GitCommit = "unknown" // Set via -ldflags "-X github.com/open-edge-platform/edge-node-agents/platform-update-agent/inbm/internal/inbd/telemetry.GitCommit=commit_hash"
	BuildDate = "unknown" // Set via -ldflags "-X github.com/open-edge-platform/edge-node-agents/platform-update-agent/inbm/internal/inbd/telemetry.BuildDate=build_date"
)
