 ...
 */
 ...
 func RemoveApplicationSourceCmd() *cobra.Command {
	 ...
	 cmd := &cobra.Command{
		 ...
		 RunE:  handleRemoveApplicationSource(&filename, &gpgKeyName),
	 }
 ...
 func handleRemoveApplicationSource(filename *string, gpgKeyName *string) func(*cobra.Command, []string) error {
