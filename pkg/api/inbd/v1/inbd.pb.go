...
type HardwareInfo struct {
	...
	Manufacturer        string `protobuf:"bytes,1,opt,name=manufacturer,proto3" json:"manufacturer,omitempty"`                                             // Hardware manufacturer
	Product             string `protobuf:"bytes,2,opt,name=product,proto3" json:"product,omitempty"`                                                       // Product type
	Stepping            string `protobuf:"bytes,3,opt,name=stepping,proto3" json:"stepping,omitempty"`                                                     // Stepping
	Sku                 string `protobuf:"bytes,4,opt,name=sku,proto3" json:"sku,omitempty"`                                                               // SKU
	Model               string `protobuf:"bytes,5,opt,name=model,proto3" json:"model,omitempty"`                                                           // Model number
	SerialSum           string `protobuf:"bytes,6,opt,name=serial_sum,json=serialSum,proto3" json:"serial_sum,omitempty"`                                  // Serial number
	SystemManufacturer  string `protobuf:"bytes,7,opt,name=system_manufacturer,json=systemManufacturer,proto3" json:"system_manufacturer,omitempty"`       // System manufacturer
	SystemProductName   string `protobuf:"bytes,8,opt,name=system_product_name,json=systemProductName,proto3" json:"system_product_name,omitempty"`        // System product name
	CpuId               string `protobuf:"bytes,9,opt,name=cpu_id,json=cpuId,proto3" json:"cpu_id,omitempty"`                                              // CPU identifier
	TotalPhysicalMemory string `protobuf:"bytes,10,opt,name=total_physical_memory,json=totalPhysicalMemory,proto3" json:"total_physical_memory,omitempty"` // Total physical memory
	DiskInformation     string `protobuf:"bytes,11,opt,name=disk_information,json=diskInformation,proto3" json:"disk_information,omitempty"`               // Disk information
}
...
func (x *HardwareInfo) GetProduct() string {
	if x != nil {
		return x.Product
	}
	return ""
...
func (x *HardwareInfo) GetStepping() string {
	if x != nil {
		return x.Stepping
	}
	return ""
...
func (x *HardwareInfo) GetSerialSum() string {
	if x != nil {
		return x.SerialSum
	}
	return ""
...
type FirmwareInfo struct {
	...
	BootFwDate      *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=boot_fw_date,json=bootFwDate,proto3" json:"boot_fw_date,omitempty"`                // Firmware date
	BootFwVendor    string                 `protobuf:"bytes,2,opt,name=boot_fw_vendor,json=bootFwVendor,proto3" json:"boot_fw_vendor,omitempty"`          // Firmware vendor
	BootFwVersion   string                 `protobuf:"bytes,3,opt,name=boot_fw_version,json=bootFwVersion,proto3" json:"boot_fw_version,omitempty"`       // Firmware version
	BiosVendor      string                 `protobuf:"bytes,4,opt,name=bios_vendor,json=biosVendor,proto3" json:"bios_vendor,omitempty"`                  // BIOS vendor
	BiosVersion     string                 `protobuf:"bytes,5,opt,name=bios_version,json=biosVersion,proto3" json:"bios_version,omitempty"`               // BIOS version
	BiosReleaseDate *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=bios_release_date,json=biosReleaseDate,proto3" json:"bios_release_date,omitempty"` // BIOS release date
}
...
func (x *FirmwareInfo) GetBootFwDate() *timestamppb.Timestamp {
	if x != nil {
		return x.BootFwDate
	}
	return nil
...
func (x *FirmwareInfo) GetBootFwVendor() string {
	if x != nil {
		return x.BootFwVendor
	}
	return ""
}

func (x *FirmwareInfo) GetBootFwVersion() string {
	if x != nil {
		return x.BootFwVersion
	}
	return ""
}
...
type OSInfo struct {
	...
	OsType        string                 `protobuf:"bytes,1,opt,name=os_type,json=osType,proto3" json:"os_type,omitempty"`                        // Operating System type
	OsVersion     string                 `protobuf:"bytes,2,opt,name=os_version,json=osVersion,proto3" json:"os_version,omitempty"`               // Operating System version
	OsReleaseDate *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=os_release_date,json=osReleaseDate,proto3" json:"os_release_date,omitempty"` // Operating System release date
	OsInformation string                 `protobuf:"bytes,4,opt,name=os_information,json=osInformation,proto3" json:"os_information,omitempty"`   // Additional OS information
}
...
func (x *OSInfo) GetOsReleaseDate() *timestamppb.Timestamp {
	if x != nil {
		return x.OsReleaseDate
	}
	return nil
}
...
type AllInfo struct {
	...
	PowerCapabilities string        `protobuf:"bytes,5,opt,name=power_capabilities,json=powerCapabilities,proto3" json:"power_capabilities,omitempty"` // Power capabilities (Linux only)
	AdditionalInfo    []string      `protobuf:"bytes,6,rep,name=additional_info,json=additionalInfo,proto3" json:"additional_info,omitempty"`          // Any additional system information
}
...
func (x *AllInfo) GetPowerCapabilities() string {
	if x != nil {
...
var file_inbd_v1_inbd_proto_rawDesc = []byte{
	...
	0x64, 0x5f, 0x75, 0x72, 0x6c, 0x12, 0x18, 0x75, 0x72, 0x6c, 0x20, 0x6d, 0x75, 0x73, 0x74, 0x20,
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x42, 0x06, 0xba, 0x48, 0x03, 0xc8, 0x01, 0x01, 0x52, 0x0b, 0x72,
	...
	0x75, 0x72, 0x6c, 0x12, 0x18, 0x75, 0x72, 0x6c, 0x20, 0x6d, 0x75, 0x73, 0x74, 0x20, 0x62, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x62, 0x69, 0x6f, 0x73, 0x56, 0x65, 0x72, 0x73,
	0x69, 0x6f, 0x6e, 0x12, 0x46, 0x0a, 0x11, 0x62, 0x69, 0x6f, 0x73, 0x5f, 0x72, 0x65, 0x6c, 0x65,
	0x61, 0x73, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
	0x2e, 0x54, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x0f, 0x62, 0x69, 0x6f, 0x73,
	0x52, 0x65, 0x6c, 0x65, 0x61, 0x73, 0x65, 0x44, 0x61, 0x74, 0x65, 0x22, 0xab, 0x01, 0x0a, 0x06,
	0x4f, 0x53, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x17, 0x0a, 0x07, 0x6f, 0x73, 0x5f, 0x74, 0x79, 0x70,
	...
	,
	...
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x22, 0xd2, 0x01, 0x0a, 0x0f, 0x53, 0x6f,
	0x66, 0x74, 0x77, 0x61, 0x72, 0x65, 0x50, 0x61, 0x63, 0x6b, 0x61, 0x67, 0x65, 0x12, 0x12, 0x0a,
	...
	0x64, 0x6f, 0x72, 0x12, 0x3d, 0x0a, 0x0c, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x5f, 0x64,
	...
	0x74, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x6c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x18, 0x05, 0x20,
	...
	,
	...
	0x0e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4f, 0x53, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12,
	0x1e, 0x2e, 0x69, 0x6e, 0x62, 0x64, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x4f, 0x53, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x17, 0x2e, 0x69, 0x6e, 0x62, 0x64, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x55, 0x0a, 0x14, 0x41, 0x64, 0x64, 0x41,
	0x70, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x12, 0x24, 0x2e, 0x69, 0x6e, 0x62, 0x64, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x64, 0x64, 0x41, 0x70,
	...
	,
	...
	0x05, 0x51, 0x75, 0x65, 0x72, 0x79, 0x12, 0x15, 0x2e, 0x69, 0x6e, 0x62, 0x64, 0x2e, 0x76, 0x31,
	0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e,
	0x69, 0x6e, 0x62, 0x64, 0x2e, 0x76, 0x31, 0x2e, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x3a, 0x5a, 0x38, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
	0x63, 0x6f, 0x6d, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x6c, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x6c, 0x2d,
	0x69, 0x6e, 0x62, 0x2d, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74,
	0x79, 0x2f, 0x70, 0x6b, 0x67, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x69, 0x6e, 0x62, 0x64, 0x2f, 0x76,
...
var file_inbd_v1_inbd_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_inbd_v1_inbd_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_inbd_v1_inbd_proto_goTypes = []interface{}{
	(QueryOption)(0), // 0: inbd.v1.QueryOption
	(UpdateSystemSoftwareRequest_DownloadMode)(0), // 1: inbd.v1.UpdateSystemSoftwareRequest.DownloadMode
	(*UpdateFirmwareRequest)(nil),                 // 2: inbd.v1.UpdateFirmwareRequest
	(*UpdateSystemSoftwareRequest)(nil),           // 3: inbd.v1.UpdateSystemSoftwareRequest
	(*UpdateOSSourceRequest)(nil),                 // 4: inbd.v1.UpdateOSSourceRequest
	(*AddApplicationSourceRequest)(nil),           // 5: inbd.v1.AddApplicationSourceRequest
	(*RemoveApplicationSourceRequest)(nil),        // 6: inbd.v1.RemoveApplicationSourceRequest
	(*UpdateResponse)(nil),                        // 7: inbd.v1.UpdateResponse
	(*LoadConfigRequest)(nil),                     // 8: inbd.v1.LoadConfigRequest
	(*GetConfigRequest)(nil),                      // 9: inbd.v1.GetConfigRequest
	(*SetConfigRequest)(nil),                      // 10: inbd.v1.SetConfigRequest
	(*AppendConfigRequest)(nil),                   // 11: inbd.v1.AppendConfigRequest
	(*RemoveConfigRequest)(nil),                   // 12: inbd.v1.RemoveConfigRequest
	(*ConfigResponse)(nil),                        // 13: inbd.v1.ConfigResponse
	(*GetConfigResponse)(nil),                     // 14: inbd.v1.GetConfigResponse
	(*QueryRequest)(nil),                          // 15: inbd.v1.QueryRequest
	(*QueryResponse)(nil),                         // 16: inbd.v1.QueryResponse
	(*QueryData)(nil),                             // 17: inbd.v1.QueryData
	(*HardwareInfo)(nil),                          // 18: inbd.v1.HardwareInfo
	(*FirmwareInfo)(nil),                          // 19: inbd.v1.FirmwareInfo
	(*OSInfo)(nil),                                // 20: inbd.v1.OSInfo
	(*SWBOMInfo)(nil),                             // 21: inbd.v1.SWBOMInfo
	(*SoftwarePackage)(nil),                       // 22: inbd.v1.SoftwarePackage
	(*VersionInfo)(nil),                           // 23: inbd.v1.VersionInfo
	(*AllInfo)(nil),                               // 24: inbd.v1.AllInfo
	(*timestamppb.Timestamp)(nil),                 // 25: google.protobuf.Timestamp
}
var file_inbd_v1_inbd_proto_depIdxs = []int32{
	25, // 0: inbd.v1.UpdateFirmwareRequest.release_date:type_name -> google.protobuf.Timestamp
	25, // 1: inbd.v1.UpdateSystemSoftwareRequest.release_date:type_name -> google.protobuf.Timestamp
	1,  // 2: inbd.v1.UpdateSystemSoftwareRequest.mode:type_name -> inbd.v1.UpdateSystemSoftwareRequest.DownloadMode
	0,  // 3: inbd.v1.QueryRequest.option:type_name -> inbd.v1.QueryOption
	17, // 4: inbd.v1.QueryResponse.data:type_name -> inbd.v1.QueryData
	25, // 5: inbd.v1.QueryData.timestamp:type_name -> google.protobuf.Timestamp
	18, // 6: inbd.v1.QueryData.hardware:type_name -> inbd.v1.HardwareInfo
	19, // 7: inbd.v1.QueryData.firmware:type_name -> inbd.v1.FirmwareInfo
	20, // 8: inbd.v1.QueryData.os_info:type_name -> inbd.v1.OSInfo
	21, // 9: inbd.v1.QueryData.swbom:type_name -> inbd.v1.SWBOMInfo
	23, // 10: inbd.v1.QueryData.version:type_name -> inbd.v1.VersionInfo
	24, // 11: inbd.v1.QueryData.all_info:type_name -> inbd.v1.AllInfo
	25, // 12: inbd.v1.FirmwareInfo.boot_fw_date:type_name -> google.protobuf.Timestamp
	25, // 13: inbd.v1.FirmwareInfo.bios_release_date:type_name -> google.protobuf.Timestamp
	25, // 14: inbd.v1.OSInfo.os_release_date:type_name -> google.protobuf.Timestamp
	22, // 15: inbd.v1.SWBOMInfo.packages:type_name -> inbd.v1.SoftwarePackage
	25, // 16: inbd.v1.SWBOMInfo.collection_timestamp:type_name -> google.protobuf.Timestamp
	25, // 17: inbd.v1.SoftwarePackage.install_date:type_name -> google.protobuf.Timestamp
	25, // 18: inbd.v1.VersionInfo.build_date:type_name -> google.protobuf.Timestamp
	18, // 19: inbd.v1.AllInfo.hardware:type_name -> inbd.v1.HardwareInfo
	19, // 20: inbd.v1.AllInfo.firmware:type_name -> inbd.v1.FirmwareInfo
	20, // 21: inbd.v1.AllInfo.os_info:type_name -> inbd.v1.OSInfo
	23, // 22: inbd.v1.AllInfo.version:type_name -> inbd.v1.VersionInfo
	3,  // 23: inbd.v1.InbService.UpdateSystemSoftware:input_type -> inbd.v1.UpdateSystemSoftwareRequest
	4,  // 24: inbd.v1.InbService.UpdateOSSource:input_type -> inbd.v1.UpdateOSSourceRequest
	5,  // 25: inbd.v1.InbService.AddApplicationSource:input_type -> inbd.v1.AddApplicationSourceRequest
	6,  // 26: inbd.v1.InbService.RemoveApplicationSource:input_type -> inbd.v1.RemoveApplicationSourceRequest
	8,  // 27: inbd.v1.InbService.LoadConfig:input_type -> inbd.v1.LoadConfigRequest
	9,  // 28: inbd.v1.InbService.GetConfig:input_type -> inbd.v1.GetConfigRequest
	10, // 29: inbd.v1.InbService.SetConfig:input_type -> inbd.v1.SetConfigRequest
	11, // 30: inbd.v1.InbService.AppendConfig:input_type -> inbd.v1.AppendConfigRequest
	12, // 31: inbd.v1.InbService.RemoveConfig:input_type -> inbd.v1.RemoveConfigRequest
	2,  // 32: inbd.v1.InbService.UpdateFirmware:input_type -> inbd.v1.UpdateFirmwareRequest
	15, // 33: inbd.v1.InbService.Query:input_type -> inbd.v1.QueryRequest
	7,  // 34: inbd.v1.InbService.UpdateSystemSoftware:output_type -> inbd.v1.UpdateResponse
	7,  // 35: inbd.v1.InbService.UpdateOSSource:output_type -> inbd.v1.UpdateResponse
	7,  // 36: inbd.v1.InbService.AddApplicationSource:output_type -> inbd.v1.UpdateResponse
	7,  // 37: inbd.v1.InbService.RemoveApplicationSource:output_type -> inbd.v1.UpdateResponse
	13, // 38: inbd.v1.InbService.LoadConfig:output_type -> inbd.v1.ConfigResponse
	14, // 39: inbd.v1.InbService.GetConfig:output_type -> inbd.v1.GetConfigResponse
	13, // 40: inbd.v1.InbService.SetConfig:output_type -> inbd.v1.ConfigResponse
	13, // 41: inbd.v1.InbService.AppendConfig:output_type -> inbd.v1.ConfigResponse
	13, // 42: inbd.v1.InbService.RemoveConfig:output_type -> inbd.v1.ConfigResponse
	7,  // 43: inbd.v1.InbService.UpdateFirmware:output_type -> inbd.v1.UpdateResponse
	16, // 44: inbd.v1.InbService.Query:output_type -> inbd.v1.QueryResponse
...
func file_inbd_v1_inbd_proto_init() {
	...
	file_inbd_v1_inbd_proto_msgTypes[15].OneofWrappers = []interface{}{
